...
| 008 | [焦點/暫停閘控](story-008-focus-pause-gating.md) | Integration | 🟡 **邏輯半部 Complete(2026-09-15)** —— 擱置經管理者重新裁決解除,見下方 | M(約 5–6 小時) | 九 | 002, 005 |
...
> 🔴 **2026-09-15 更新:008 已由管理者重新裁決解除並實作完成,其餘三張維持擱置。**
> **解除理由是擱置裁決的前提變了,不是裁決被推翻**:原裁決依據是「玩家看不出差別」,
> 而 2026-09-15 管理者裁決「要讓玩家在畫面上真的打得到卡牌」——
> 打牌要把 `Esc`/手把 `B` 讓給取消,而那兩個鍵目前是玩家唯一能結束回合的手段,
> 因此**戰鬥選單非做不可**,而選單打開時游標必須停止裁定 —— **那正是 008。**
> 亦即 008 從「玩家看不出差別」變成「玩家看得到的功能的必要前置」。
>
> 🔴 **這次解除是怎麼被發現需要裁決的,值得記住**:協調者原本【沒有】發現要裁決 ——
> 四張擱置工作單的檔頭當時**全部寫著 `Status: Ready`**,而 epic 與計畫檔寫擱置。
> 協調者讀了工作單那一份就直接派工,做完才在更新狀態時撞見本節。
> **四張的檔頭已於同日更正**,並在各自檔頭寫明「擱置不等於可以開」。
> 📌 **教訓與本 epic 下方 014 那次誤讀同形**:轉述一條裁決之前先讀它的原文 ——
> 這次是「只讀了一份文件,而另一份講相反的話」。
