...
Task: 🔴 **2026-08-31 第二十四批(第二輪查核 + 兩系統核准)。`/design-review affinity-position-chain.md` 第二輪完成並離開審查流程;管理者同日核准 #5 與 #4;OQ-2 找到既有擁有者、OQ-16(b) 判定不必存在而取消。🔴 下一步只剩一把鎖:ADR-0001 從 Proposed 推到 Accepted —— 見下方「接手第一件事」。**
<!-- /STATUS -->

## 🔴 接手第一件事(2026-08-31 第二十四批寫入 —— 取代下方第二十三批的指示順位)
...
**缺的是引擎層,不是文件層。前者要從零審一道,後者只要跑 6 支探針。**
