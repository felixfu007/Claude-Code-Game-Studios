...
Task: 🟡 **2026-09-01 第二十六批:待裁決第 1 項(ADR-0005 單一根 Viewport 假設)查清楚了 —— 它的世界層那一半 2026-08-27 就實測結案,只是沒人寫回文件。** 已把五處「尚未處理」的記錄改對。**殘留的是介面層那一半(VR #11b),而它取決於 `art-direction.md` 第七節待決項 3「介面設計基準畫布尺寸」—— 現在的形狀是「定一個數字」,不是「重審 1609 行 ADR」。** 第二十五批全庫稽核見 docs/reviews/doc-audit-2026-09-01.md。
<!-- /STATUS -->
...
| # | 事項 | 狀態 |
|---|---|---|
| 1 | **ADR-0005 的「單一根 Viewport 假設」重新裁決** | 🟡 **範圍已大幅縮小(2026-09-01 第二十六批更正)**。該假設的**世界層那一半 2026-08-27 就實測結案了**(`prototypes/board-render-input-spike-2026-08-27/`,判定**條件成立**,20/20 自洽 + 主 session 獨立複驗),只是**沒人把結果寫回任何文件**,五處記錄仍寫「尚未處理」。剩下的是介面層那一半(VR #11b),而**它取決於 `art-direction.md` 第七節待決項 3「介面設計基準畫布尺寸」** —— 現在的形狀是「定一個數字」,不是「重審 1609 行」。**ADR-0005 本體仍未動。** |
