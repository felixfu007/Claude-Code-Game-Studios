...
| 2 | 存檔系統(含跨規則集遷移) | Persistence | MVP | Designed(待審查——已完成第四輪 `/design-review` 修訂,待第五輪重新覆核) | design/gdd/save-system.md | — |
