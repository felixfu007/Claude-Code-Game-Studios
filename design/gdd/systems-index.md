...
| Design docs approved | **4**(2026-08-31 更新——好感度—位置連鎖系統〔#5〕經管理者裁決核准,補計入;前次 3:好感度數值池〔第十一、十二輪〕、存檔系統〔第十五輪〕、單一游標/高亮狀態系統〔第十六輪,使用者裁決收斂〕)<br>**⚠️ 本指標定義與 Status 欄在戰棋移動與交戰系統上會分歧,不得默默選一邊(2026-08-18 明文化)**:本指標的原定義是「**目前無待清償 Blocking**」的系統數,而戰棋移動與交戰系統目前**確實無待清償 Blocking**(四輪發現皆於同輪修訂落地),但它**不計入本數**——因為 `/design-review` Phase 0b 的收斂規則另外要求**連續兩輪 body-scoped 零 BLOCKING** 才得判 Approved,該系統連續零 BLOCKING 輪數目前為 **0**。換言之:「無待清償 Blocking」是 Approved 的必要而非充分條件。本指標追蹤的是**已判 Approved 的系統數**,以 Status 欄為準<br>🔴 **2026-08-31 補記 —— 上述規則已被管理者裁決推翻一次,而且推翻是明文的**:#5 同樣未達「連續兩輪零 BLOCKING」,但依劑量裁決規則 2(每份文件 ≤ 2 輪、第 2 輪殘留項降級為實作期處理)核准。**兩條規則在上限之下結構上不可能同時滿足,管理者裁決位階較高。** 因此 #4 目前之所以未核准,**不是因為它撞到收斂規則**(那條已讓步),而是因為它尚未有人對它下裁決。⚠️ **不得再以「連續零 BLOCKING 輪數為 0」單獨作為不核准 #4 的理由。** |
| MVP systems designed | **4/9**(2026-08-31 更新——補入好感度—位置連鎖系統〔#5,Approved〕;分子為好感度數值池、單一游標/高亮狀態系統、好感度—位置連鎖系統〔三者皆 Approved〕、戰棋移動與交戰系統〔Designed 未 Approved〕。分母 9 見 Priority Tiers 的 2026-08-25 裁決。⚠️ 存檔系統雖已 Approved 但不再計入本欄,它現屬垂直切片層) |
